...
class ServiceProcezorExampleWithSalaryHomeOfficeTest extends AnyFunSpec {
    def getTargetsFromDb(period: IPeriod): Array[ITermTarget] = {
        ...
        val targets  = Array[ITermTarget](
            ...
            new ExampleTermTarget(montCode, contract, position, variant1,
                ArticleCode.get(ExampleArticleConst.ARTICLE_ALLOWCE_HOFFICE.id),
    ...
    describe("Procezor Example - Salary-HomeOffice") {
        ...
        val testArticles = Array[Int](80001, 80005, 80002, 80006, 80007, 80010, 80012, 80008, 80009, 80011, 80013)
